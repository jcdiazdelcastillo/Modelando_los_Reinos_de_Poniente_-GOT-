...
const robb = new Guerrero("Robb Stark", 22, true, casaStark, espadaLarga);
...
casaStark.agregarPersonajeCasa(robb);
casaStark.agregarPersonajeCasa(brienne);

casaLannister.agregarPersonajeCasa(jaime);
casaLannister.agregarPersonajeCasa(cersei);
casaLannister.agregarPersonajeCasa(tyrion);
casaLannister.agregarPersonajeCasa(gregor);

casaStark.miembrosCasa();
casaLannister.miembrosCasa();
